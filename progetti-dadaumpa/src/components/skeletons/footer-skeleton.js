  ...
  return (
    <footer className="w-full border-t bg-white">
      <div className="relative w-full flex items-center md:pb-12 overflow-hidden ">
        ...
        <button className="absolute bg-polynesian-blue hover:bg-telemagenta text-white text-2xl font-bold hover:shadow rounded-full w-16 h-16 ml-12 transition-all duration-200">
          &#8592;
        </button>
        <button className="absolute right-0 bg-polynesian-blue hover:bg-telemagenta text-white text-2xl font-bold hover:shadow rounded-full w-16 h-16 mr-12 transition-all duration-200">
          &#8594;
        </button>
      </div>
      <div className="w-full container mx-auto flex flex-col items-center ">
        <div className="flex flex-row text-center py-2 space-y-0 space-x-4">
          <a
            href="#!"
            role="button"
            class="hover:scale-125 transition-all duration-200">
