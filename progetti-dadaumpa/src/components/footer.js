  ...
  return (
    <footer className="w-full border-t bg-white pb-12">
      ...
      <div className="w-full container mx-auto flex flex-col items-center">
        <div className="flex flex-col md:flex-row text-center md:text-left md:justify-between py-2 space-y-4 md:space-y-0 md:space-x-4">
          <a href="#!" role="button" class="hover:scale-125">
        ...
        <div className="flex flex-col md:flex-row text-center md:text-left md:justify-between py-6">
          <a
            href="#"
            className="px-3 hover:text-telemagenta hover:underline underline-offset-4 hover:scale-110">
            Chi siamo
          </a>
          <a
            href="#"
